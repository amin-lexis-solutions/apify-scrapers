// actor-testing https://apify.com/pocesar/actor-testing#output

// Prepare Actor input
export async function createTest (actorId, input, testName, slackChannel, slackPrefix) {
    return {
        ...
        "testSpec": ({ it, run, expect, expectAsync, describe }) => {
            ...
            describe(`Actor testing`, () => {
                ...
                it('Call actor by id', async ({ actorId, input }) => {

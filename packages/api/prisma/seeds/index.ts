...
const localesToImport = [
  ...
  'en_AE', 'en_AU', 'en_CA', 'en_GB', 'en_IE',
  'en_NZ', 'en_SG', 'en_US', 'es_AR', 'es_CO',
  'es_ES', 'es_MX', 'fi_FI', 'fr_BE', 'fr_CH',
  'fr_FR', 'hu_HU', 'it_CH', 'it_IT', 'ko_KR',
  'nb_NO', 'nl_BE', 'nl_NL', 'pl_PL', 'pt_BR',
  'pt_PT', 'ro_RO', 'sk_SK', 'sv_SE',
];

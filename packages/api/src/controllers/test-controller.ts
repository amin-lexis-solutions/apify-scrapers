import { Authorized, BadRequestError, Body, Get, JsonController, Param, Post, QueryParams } from 'routing-controllers';
...
export class TestController {
    ...
    async scheduleActors(@Body() params: RunTestBody) {
        ...
        return new StandardResponse(`Added ${actorsAdded} actors to test`, false, {})
    }
  ...
  @ResponseSchema(StandardResponse)
  async test(@Param('id') id: string, @Body() params: TestRequestBody): Promise<StandardResponse> {
    if (!id || id.trim() === '') {
